...
**Logos-Log**는 사용자의 고민과 일기 내용을 심리학 논문 발췌와 연결해, 근거가 보이는 성찰 질문을 제공하는 RAG 저널링 플랫폼입니다. 단순한 공감형 챗봇이 아니라, 논문 검색·재랭킹·주변 문맥 확장·인용 UI·정량 평가까지 포함한 학술 기반 RAG 시스템을 목표로 합니다.
...
- **해결 방안:** 사용자의 일상과 감정을 **긍정 심리학 및 의미 치료(Logotherapy) 등 심리학 논문 발췌**와 연결합니다. 이를 통해 일시적인 위안에 머무르지 않고, 근거를 확인할 수 있는 자아 성찰과 삶의 의미 재구성(Meaning-Making)을 돕습니다.
